    ...
    <>
      ...
      <div className="w-full bg-white-A700">
        <div className="flex flex-col items-center overflow-auto">
          <header className="flex md:flex-col self-stretch justify-between items-center gap-5 p-[9px] z-[1] bg-gradient">
            <Img src="images/img_png_3.png" alt="pngthree_one" className="w-[8%] md:w-full mt-2 mb-2.5 object-cover" />
            <div className="flex sm:flex-col justify-between items-center w-[48%] md:w-full mt-3 pr-1.5 gap-5 py-1.5">
              ...
              <ul className="flex self-start gap-[25px]">
                <li>
                  <div className="flex items-center">
                    <Text as="p" className="self-start !text-gray-900">
                      Pages
            ...
            <div className="flex justify-center items-center w-[15%] md:w-full mt-2 mr-[13px] gap-4 md:mr-0">
              ...
              <Button
                ...
                rightIcon={<Img src="images/img_right_arrow_24_outline.svg" alt="right arrow / 24 / Outline" />}
                className="gap-1 sm:pl-5 font-semibold min-w-[143px] rounded-[21px]"
              >
                GET QUOTE
              </Button>
            </div>
          ...
          <div className="flex flex-col items-start w-full mt-[116px] gap-[94px] mx-auto md:gap-[70px] md:p-5 sm:gap-[47px] max-w-[1242px]">
            ...
            <div className="flex flex-col self-stretch gap-[54px] sm:gap-[27px]">
              <div className="flex md:flex-col justify-between gap-5">
                <Img src="images/img_google.png" alt="google_one" className="w-[9%] md:w-full object-cover" />
          ...
          <div className="flex flex-col items-center w-full mt-[114px] gap-[94px] mx-auto md:gap-[70px] md:p-5 sm:gap-[47px] max-w-[1250px]">
            ...
            <div className="self-stretch justify-center gap-[25px] grid-cols-[repeat(auto-fill,_minmax(356px_,_1fr))] grid">
              <div className="flex flex-col items-center h-[450px] w-full md:h-auto gap-[9px] p-[22px] sm:p-5 bg-[url(/public/images/img_group_25.svg)] bg-cover bg-no-repeat rounded-[20px]">
                <Img src="images/img_s4_il_1_1.png" alt="s4il1one_one" className="w-[28%] object-cover" />
                <div className="flex flex-col self-stretch items-center mb-7">
                  <Heading size="s" as="h3">
                    Strategy & Planning
                  </Heading>
                  <Text as="p" className="mt-[17px] !text-blue_gray-500 text-center">
                    <>
              ...
              <div className="flex flex-col items-center h-[450px] w-full md:h-auto p-[22px] sm:p-5 bg-[url(/public/images/img_group_25.svg)] bg-cover bg-no-repeat rounded-[20px]">
                <Img src="images/img_s4_il_2_1.png" alt="s4il2one_one" className="w-[48%] object-cover" />
                <Heading size="s" as="h4" className="mt-[11px]">
                  Planning & Strategy
                </Heading>
                <Text as="p" className="w-[96%] md:w-full mt-[15px] !text-blue_gray-500 text-center">
                  <>
                    Lorem ipsum dolor sit amet bibendum elit sit <br />
                    finibus. Maximus sodales parturien lore arcu <br />
                    eros vel erat pede netus qu.
                ...
                <Button size="4xl" shape="square" className="mt-[31px] mb-7">
                  <Img src="images/img_arrow.png" />
                </Button>
              </div>
              <div className="flex flex-col items-center h-[450px] w-full md:h-auto p-[22px] sm:p-5 bg-[url(/public/images/img_group_25.svg)] bg-cover bg-no-repeat rounded-[20px]">
                <Img src="images/img_s4_il_3_1.png" alt="s4il3one_one" className="w-[37%] object-cover" />
              ...
              <div className="h-[450px] w-full bg-gray-300_33 relative rounded-[20px]">
                ...
                <div className="h-[221px] w-[93%] bottom-[0.00px] left-[0.00px] m-auto absolute">
                  <div className="flex items-center w-[66%] bottom-[0.90px] left-[0.00px] m-auto absolute">
                    <div className="flex items-center flex-1">
                      ...
                      />
                      <div className="self-end h-[80px] w-[80px] mb-[51px] ml-[-42px] relative bg-gray-200 rounded-[40px]" />
                    </div>
                    <div className="self-end w-[26%] mb-[51px] ml-[-69px] p-2.5 relative bg-gray-100 rounded-[40px]">
                      <Img src="images/img_arrow.png" alt="arrow_one" className="w-[60px] object-cover" />
                    </div>
                  </div>
                  <Text
                    as="p"
              ...
              <div className="flex flex-col items-center h-[450px] w-full md:h-auto p-3.5 bg-[url(/public/images/img_group_25.svg)] bg-cover bg-no-repeat rounded-[20px]">
                <Img src="images/img_s4_il_5_1.png" alt="s4il5one_one" className="w-[150px] object-cover" />
                <Heading size="s" as="h4" className="mt-[19px]">
                  Design & Development
                </Heading>
                <Text as="p" className="w-[92%] md:w-full mt-[15px] !text-blue_gray-500 text-center">
                  <>
                    Lorem ipsum dolor sit amet bibendum elit sit <br />
                    finibus. Maximus sodales parturien lore arcu <br />
                    eros vel erat pede netus qu.
                ...
                <Button size="4xl" shape="square" className="mt-[31px] mb-9">
                  <Img src="images/img_arrow.png" />
                </Button>
              </div>
              <div className="flex flex-col items-center h-[450px] w-full md:h-auto p-3.5 bg-[url(/public/images/img_group_25.svg)] bg-cover bg-no-repeat rounded-[20px]">
                <Img src="images/img_s4_il_6_1.png" alt="s4il6one_one" className="w-[48%] object-cover" />
                <Heading size="s" as="h4" className="mt-[19px]">
                  Seo Audits & Strategy
                </Heading>
                <Text as="p" className="w-[92%] md:w-full mt-[15px] !text-blue_gray-500 text-center">
          ...
          <div className="flex md:flex-col self-end w-full mt-[51px] gap-10 mx-auto md:p-5 max-w-[2248px]">
            <div className="w-[24%] md:w-full py-5 bg-white-A700 rounded-[20px]">
